        ...
        if x=='answer':
            ...
            if user.userprofile.mode=="move":
                ...
                if moveallowed(user.userprofile.xpos,x,user.userprofile.ypos,y):
                    ...
                    return render(request, 'event/home.html', {'myrange_x':myrange_x,'myrange_y':myrange_y,'myrange':myrange,'dbsquares':dbsquares,'squares': squares, 'square_size': square_size,'dbdic':square_dict,'question':question,'answers':answers})
